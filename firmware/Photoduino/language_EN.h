...
const prog_char PROGMEM MSG_CONFIG_DROPS[] =                      "Config Drops";
...
const prog_char PROGMEM MSG_AUTOFOCUS_TIME[] =                    "Autofocus Time";
const prog_char PROGMEM MSG_SHUTTERLAG_TIME[] =                   "Shutterlag Time";
const prog_char PROGMEM MSG_USE_FLASH1[] =                        "Use Flash1";
const prog_char PROGMEM MSG_USE_FLASH2[] =                        "Use Flash2";
const prog_char PROGMEM MSG_FLASH1_PRETIME[] =                    "Flash1 Pretime";
const prog_char PROGMEM MSG_FLASH2_PRETIME[] =                    "Flash2 Pretime";
const prog_char PROGMEM MSG_CLOSE_PRETIME[] =                     "Close Pretime";
const prog_char PROGMEM MSG_INTERVAL_UNITS[] =                    "Interval Units";
const prog_char PROGMEM MSG_INTERVAL_VALUE[] =                    "Interval Value";
const prog_char PROGMEM MSG_CYCLES[] =                            "Cycles";
...
const prog_char PROGMEM MSG_SHOOTING_MODE[] =                     "Shooting Mode";
const prog_char PROGMEM MSG_INTERCYCLE_TIME[] =                   "Intercycle Time";
const prog_char PROGMEM MSG_BACKLIGHT[] =                         "Backlight";
const prog_char PROGMEM MSG_SPEAKER[] =                           "Speaker";
...
const prog_char PROGMEM MSG_UNITS_CYCLES[] =                      "Cycles";
const prog_char PROGMEM MSG_UNITS_DROPS[] =                       "Drops";
const prog_char PROGMEM MSG_SHOOTINGMODE_NORMAL[] =               "Normal";
const prog_char PROGMEM MSG_SHOOTINGMODE_PREBULB[] =              "Pre-Bulb Mode";
const prog_char PROGMEM MSG_SHOOTINGMODE_MIRRORLOCKUP[] =         "Mirror Lock-Up";
const prog_char PROGMEM MSG_SENSOR_TUNING[] =                     "Sensor Tuning";
...
const prog_char PROGMEM MSG_SENSOR_TYPE_BARRIER[] =               "Barrier";
const prog_char PROGMEM MSG_SENSOR_TYPE_SHOCK[] =                 "Shock";
const prog_char PROGMEM MSG_SENSOR_TYPE_LIGHT[] =                 "Light";
const prog_char PROGMEM MSG_MIRROR_LOCKUP_TIMEOUT[] =             "Mirror Timeout";
const prog_char PROGMEM MSG_DEVICE_PORT_TYPE[] =                  "Device Type";
const prog_char PROGMEM MSG_DEVICE_PORT_TYPE_LASER[] =            "Laser";
const prog_char PROGMEM MSG_DEVICE_PORT_TYPE_SOLENOID_VALVE[] =   "Solenoid Valve";
const prog_char PROGMEM MSG_DROPS_COUNT[] =                       "Drops Count";
